...
public:
    ...
    void readVerifyCaptcha();
    const std::string getVerifyCaptchaSecret();
    const int getVerifyCaptchaOpen();
private:
    //
...
public:
    ...
    //
    int asyncReportQSUserActInfo(const gamerecord::ReportQSUserActInfoReq &req);
    //
...
public:
    ...
    int isLoginTestOpen(){return LoginTestOpen;}
private:
    //拆分字符串成整形
...
private:
    ...
    string VerifyCaptchaSecret;
    int VerifyCaptchaOpen;
    int LoginTestOpen;
};
